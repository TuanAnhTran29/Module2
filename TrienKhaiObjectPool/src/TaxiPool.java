...
public class TaxiPool {
    ...
    private static final int NUMBER_OF_TAXI = 4;private final List<Taxi> available = Collections.synchronizedList(new ArrayList<>());
    ...
    public void waitingUntilTaxiAvailable(){
        if (waiting.get()){
            waiting.set(false);
